# Contributing to DHT22PIO_RP2040
...
- Use the [Bug Report](https://github.com/angeloINTJ/DHT22PIO_RP2040/issues/new?template=bug_report.md) issue template
- Include your board model, Arduino core version, and a minimal sketch to reproduce

### Suggesting Features

- Use the [Feature Request](https://github.com/angeloINTJ/DHT22PIO_RP2040/issues/new?template=feature_request.md) issue template
...
- DHT11 support (different timing, 8-bit resolution)
- Dew point calculation utility
- Comfort level classification (dry / comfortable / humid)
- Moving average / filtering utilities
- Multi-sensor concurrent reading (one SM per sensor)
